...
import './styles.css';
import CardTitlePoster from '../../components/card-title-poster';
import { MdOutlineArrowBackIosNew } from 'react-icons/md';
import { MdOutlineArrowForwardIos } from 'react-icons/md';



const CarouselSimplePoster = ({ name, titles }) => {
  ...
  return (
    <div>
      ...
      <div className='content-simple-carousel'>
        <button id="low" onClick={previous} className="btnPreviousRP">
        ...
        <button className="btnNextRP" id="low" onClick={next}>
...
export default CarouselSimplePoster;